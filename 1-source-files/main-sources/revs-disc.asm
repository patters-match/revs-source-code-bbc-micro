...
\ ------------------------------------------------------------------------------
\
\ This source file produces an SSD disc image for Revs on the BBC Micro.
\
\ ------------------------------------------------------------------------------
\
...
IF _ACORNSOFT
 ...
 PUTFILE "3-assembled-output/Revs2.bin", "Revs3", &001200, &001200
 PUTFILE "3-assembled-output/Revs2Patch.bin", "Revs2", &007000, &007000
